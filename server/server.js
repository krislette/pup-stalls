...
const rentHistoryRouter = require("./routers/rentHistoryRouter");
...
// Mount rentHistoryRouter for handling rent history-related operations
app.use("/history", rentHistoryRouter);
